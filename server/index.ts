...
export function createServer() {
  ...
  app.get("/api/twilio-status", (_req, res) => {
    const status = {
      ...
      TWILIO_WHATSAPP_FROM: process.env.TWILIO_WHATSAPP_FROM || "Default: whatsapp:+14155238886",
      TWILIO_TO_NUMBER: process.env.TWILIO_TO_NUMBER || "Default: whatsapp:+212612989463",
